// Foi importado as libs do pacote github.com/lib/pq
...
func sqlInsert() {
	...
	result, err := insert.Exec(5, "Maps in Golang", "Sed ut perspiciatis unde omnis iste natus error sit volumpte")
	checkErr(err)
...
func sqlUpdate() {
	...
	result, err := update.Exec("But I must explain to you how all this mistaken idea - 2", 5)
	checkErr(err)
